understand CSS so you can apply DRY (Don't Repeat Yourself) principle
customize your html with classes and ids as needed

author img size must be smaller in blog_home and a little larger in postdetails & userposts(filtered page).
text sizes must be generalized
